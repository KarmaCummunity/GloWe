...
| GLOWE.CHAT-INBOX | **Messages inbox lists DMs with super-admin team members** — stop hiding `is_support_thread` chats; one admin-portal header icon; New message + live inbox refresh | agent-fullstack | 🟡 In progress | `spec/17_glowe_frontend.md` FR-GLOWE-016 AC2b / AC6; D-190 |
