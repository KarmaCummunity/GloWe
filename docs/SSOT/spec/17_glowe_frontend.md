...
**Status.** 🟡 In progress — Phase 1 (foundation) ✅ and Phase 2 (shell & layout) ✅ shipped 2026-09-09; Phases 3–5 per [`docs/superpowers/plans/2026-09-09-glowe-design-system-reset.md`](../../superpowers/plans/2026-09-09-glowe-design-system-reset.md). Decision `D-190`.
...
- AC3. **Component families.** 🟡 `.btn` (+ `-primary|-secondary|-outline|-ghost|-danger`, `-small|-large|-block|-icon|-pill`, `:disabled`, `[aria-busy]`, `:focus-visible`), form controls, toast/alert/empty-state/skeleton/badge ✅. Chips, cards, avatar, menu, tabs, modal → Phase 3. No page may define its own button/card/control styles.
